...
internal var KeycloakSession.clientStatus: ClientStatus?
    get() = getAttribute(TS3.CLIENT_STATUS_CLAIM, ClientStatus::class.java)
    set(value) = setAttribute(TS3.CLIENT_STATUS_CLAIM, value)
...
inline fun <reified P : Provider> KeycloakSession.provider(): P = checkNotNull(getProvider(P::class.java))
